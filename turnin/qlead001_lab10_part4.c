 ...
 *	Exercise Description: Lab 10 Exercise 3 but with frequency change
 *
...
unsigned char old0 = 0, old1 = 0;

void Freq_Tick() {
    unsigned char A0 = (~PINA)&0x01, A1 = (~PINA)&0x02;
    if (A1 != old1) {
        old1 = A1;
        if (freq > 2 && A1) freq -= 2;
    }
